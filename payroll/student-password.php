        ...
        <div class="main">
            <div class="modal_content">
                <form action="" method="post" id="changepass">
                    <h1>Change Password</h1>                    <label for="">Current Password</label><br>
                    ...
                    <div class="pass">
                        <div class="newpass">
                            <label for="">New Log-Key</label>
                            <input type="password" name="newpass" id="newpass" required>
                        </div>
                        <div class="confirmpass">
                            <label for="">Confirm Log-Key</label>
                            <input type="password" name="confirmpass" id="confirmpass" required>
                        </div>
                    </div>
                    ...
                    <input type="submit" value="Change Password" name="changepas">
                    <input type="submit" value="Update Log-key" name="changepas">
